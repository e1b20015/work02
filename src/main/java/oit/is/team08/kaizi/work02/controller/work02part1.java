package main.java.oit.is.team08.kaizi.work02.controller;
...
/**
 * work02part1Controller
 *
 * クラスの前に@Controllerをつけていると，HTTPリクエスト（GET/POSTなど）があったときに，このクラスが呼び出される
 */
@Controller
public class work02part1Controller {

  /**
   * work02part1というGETリクエストがあったら work02part1()を呼び出し，work02part1.htmlを返す
   */
  @GetMapping("/work02part1")
  public String work02part1() {
    return "work02part1.html";
  }
